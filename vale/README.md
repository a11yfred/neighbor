...
> If you manage styles manually, copy the `neighbor/` directory from this repo into your `StylesPath`.
...
Full rule documentation: [RULES-CONTENT.md](https://github.com/a11yfred/neighbor/blob/main/RULES-CONTENT.md) in the neighbor repo.
...
The term lists for `AbleistLanguage`, `DisabilityMetaphor`, `EnglishIdiom`, and `DirectionalLanguage` are defined in `lib/content-rules.js` in this repository. The YAML files here are generated from those lists.
