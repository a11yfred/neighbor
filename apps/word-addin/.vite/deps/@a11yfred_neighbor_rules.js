//#region node_modules/@a11yfred/neighbor/lib/content-rules.js
/**
...
var ABLEIST_TERMS = [
	{
		term: /\bcrip+le[sd]?\b/i,
		suggest: "person who uses a wheelchair / person with a mobility disability",
		sources: "NCDJ, AP, ADA NN, APA"
	},
	{
		term: /\bretard(ed|s)?\b/i,
		suggest: "person with an intellectual disability",
		sources: "NCDJ, AP, ADA NN, APA"
	},
	{
		term: /\bimbecile[s]?\b/i,
		suggest: "person with an intellectual disability",
		sources: "ADA NN, APA"
	},
	{
	...
	{
		term: /\bdumb\b/i,
		suggest: "mute / nonverbal / does not use speech",
		sources: "NCDJ, ADA NN"
	},
	{
		term: /\blame\b/i,
		suggest: "weak / unconvincing (for the non-disability sense)",
		sources: "NCDJ, A11y Collective"
	},
	{
		term: /\bvegetable[s]?\b/i,
		suggest: "person in a persistent vegetative state",
		sources: "ADA NN"
	},
	{
		term: /\bfreak[s]?\b/i,
	...
	{
		term: /\bspecial needs\b/i,
		suggest: "disability / person with a disability",
		sources: "NCDJ, AP, ADA NN, APA"
	},
	{
		term: /\bdifferently[- ]abled\b/i,
		suggest: "person with a disability",
		sources: "NCDJ, AP, ADA NN, APA"
	},
	{
		term: /\bhandi[- ]?capable\b/i,
		suggest: "person with a disability",
		sources: "NCDJ, AP, ADA NN"
	},
	{
		term: /\bphysically challenged\b/i,
		suggest: "person with a physical disability",
		sources: "NCDJ, AP, ADA NN, APA"
	},
	{
		term: /\bmentally challenged\b/i,
		suggest: "person with an intellectual or cognitive disability",
		sources: "ADA NN, APA"
	},
	{
		term: /\bspecial\b(?=\s+(ed|education|class|school))/i,
		suggest: "special education (acceptable in formal context) / disability services",
		sources: "NCDJ"
	},
	{
		term: /\bconfined to (a |their )?wheelchair\b/i,
		suggest: "wheelchair user / person who uses a wheelchair",
		sources: "NCDJ, AP, ADA NN, APA, SIGACCESS"
	},
	{
		term: /\bwheelchair[- ]bound\b/i,
		suggest: "wheelchair user / person who uses a wheelchair",
		sources: "NCDJ, AP, ADA NN, APA, SIGACCESS"
	},
	{
		term: /\bsuffers? from\b/i,
		suggest: "has / lives with / is diagnosed with",
		sources: "NCDJ, AP, ADA NN, APA"
	},
	{
		term: /\bafflicted (with|by)\b/i,
		suggest: "has / lives with",
		sources: "NCDJ, AP, ADA NN, APA, SIGACCESS"
	},
	{
		term: /\bvictim of\b/i,
		suggest: "person who has / person with",
		sources: "NCDJ, AP, ADA NN, APA"
	},
	{
		term: /\bbound to (a |the )?(bed|chair|wheelchair)\b/i,
		suggest: "uses a bed / uses a wheelchair",
		sources: "ADA NN, APA"
	},
	{
		term: /\bstricken (with|by)\b/i,
		suggest: "has / lives with",
		sources: "ADA NN"
	},
	{
		term: /\bcrippling\b(?!\s+(blow|defeat|loss))/i,
		suggest: "devastating / severe / debilitating",
		sources: "NCDJ, A11y Collective"
	},
	{
		term: /\bcommitted suicide\b/i,
		suggest: "died by suicide",
		sources: "ADA NN, APA (clinical consensus, AP Stylebook 2022)"
	},
	{
		term: /\bcra+zy\b/i,
		suggest: "wild / unexpected / intense (for non-clinical uses)",
		sources: "NCDJ, A11y Collective"
	},
	{
		term: /\bpsycho\b/i,
		suggest: "reckless / erratic / (rewrite)",
		sources: "NCDJ, ADA NN"
	},
	{
		term: /\bschizophrenic\b(?!\s+(disorder|diagnosis|symptom))/i,
		suggest: "contradictory / inconsistent (for non-clinical uses)",
		sources: "NCDJ, APA"
	},
	{
		term: /\b(a\s+)?manic[- ]depressive\b/i,
		suggest: "person with bipolar disorder",
		sources: "ADA NN, APA"
	},
	{
		term: /\bjunkie[s]?\b/i,
		suggest: "person with a substance use disorder",
		sources: "ADA NN, APA"
	},
	{
		term: /\baddict[s]?\b(?!\s+up)/i,
		suggest: "person with a substance use disorder / person in recovery",
		sources: "ADA NN, APA"
	},
	{
		term: /\bnormal (people|person|individuals?|users?)\b/i,
		suggest: "people without disabilities / non-disabled people",
		sources: "AP, ADA NN, APA, SIGACCESS"
	},
	{
		term: /\bnormal (hearing|vision|sight)\b/i,
		suggest: "typical hearing / full hearing / unimpaired vision",
		sources: "AP, SIGACCESS"
	},
	{
		term: /\bhearing[- ]impaired\b/i,
		suggest: "deaf / hard of hearing",
		sources: "NCDJ, AP, ADA NN, APA"
	},
	{
		term: /\bthe (disabled|blind|deaf|mentally ill)\b/i,
		suggest: "people with disabilities / blind people / deaf people / people with mental illness",
		sources: "NCDJ, AP, ADA NN, APA, SIGACCESS"
	},
	{
		term: /\bhandicapped\b/i,
		suggest: "person with a disability / accessible (for facilities)",
		sources: "NCDJ, AP, ADA NN"
	}
];
/**
...
*/
var DISABILITY_METAPHORS = [
	{
		term: /\bblind (spot|eye|to)\b/i,
		suggest: "gap / oversight / unaware of",
		sources: "NCDJ, A11y Collective"
	},
	{
		term: /\bturning a blind eye\b/i,
		suggest: "ignoring / overlooking",
		sources: "NCDJ, A11y Collective"
	},
	{
		term: /\btone[- ]deaf\b/i,
		suggest: "out of touch / insensitive / unaware",
		sources: "NCDJ, A11y Collective"
	},
	{
		term: /\bfalling on deaf ears\b/i,
		suggest: "being ignored / going unheard",
		sources: "NCDJ, A11y Collective"
	},
	{
		term: /\bdeaf ears\b/i,
		suggest: "ignored / unheard",
		sources: "A11y Collective"
	},
	{
		term: /\bparalyzed (with|by)\b/i,
		suggest: "overwhelmed by / unable to act because of",
		sources: "NCDJ, A11y Collective"
	},
	{
		term: /\bcrippling (debt|fear|blow|anxiety)\b/i,
		suggest: "devastating / crushing / severe",
		sources: "NCDJ, A11y Collective"
	},
	{
		term: /\bschizophrenic (approach|strategy|policy|market)\b/i,
		suggest: "contradictory / inconsistent / unpredictable",
		sources: "NCDJ, APA"
	},
	{
		term: /\bstands? on its own two feet\b/i,
		suggest: "self-sufficient / independent",
		sources: "A11y Collective"
	}
];
/**
...
var ENGLISH_IDIOMS = [
	{
		term: /\bboil the ocean\b/i,
		suggest: "attempt everything at once / do too much",
		sources: "SJSU, UX Content Co."
	},
	{
		term: /\bmove the needle\b/i,
		suggest: "make progress / have an impact",
		sources: "SJSU, Canadian Gov"
	},
	{
		term: /\bblue[- ]?sky thinking\b/i,
		suggest: "open-ended brainstorming / creative thinking",
		sources: "SJSU, A11y Collective"
	},
	{
		term: /\bdrink the (kool[- ]?aid|cool[- ]?aid)\b/i,
		suggest: "follow without question / accept uncritically",
		sources: "SJSU, Canadian Gov"
	},
	{
		term: /\bpeel back the onion\b/i,
		suggest: "examine more closely / dig deeper",
		sources: "SJSU"
	},
	{
		term: /\blow[- ]hanging fruit\b/i,
		suggest: "easiest tasks / quick wins",
		sources: "SJSU, UX Content Co."
	},
	{
		term: /\bsynergy\b/i,
		suggest: "collaboration / combined effect (or rewrite)",
		sources: "SJSU, plain language guides"
	},
	{
		term: /\bpivot\b(?!\s+(table|point))/i,
		suggest: "change direction / shift focus",
		sources: "UX Content Co."
	},
	{
		term: /\bbandwidth\b(?!\s*(of|for|between|connection|limit|cap))/i,
		suggest: "time / capacity / availability",
		sources: "UX Content Co., SJSU"
	},
	{
		term: /\bcircle back\b/i,
		suggest: "follow up / return to",
		sources: "SJSU, Canadian Gov"
	},
	{
		term: /\btake (it )?offline\b/i,
		suggest: "discuss separately / talk privately",
		sources: "SJSU"
	},
	{
		term: /\bdeep[- ]?dive\b/i,
		suggest: "thorough review / detailed look",
		sources: "SJSU, Canadian Gov"
	},
	{
		term: /\bgranular\b/i,
		suggest: "detailed / specific",
		sources: "SJSU"
	},
	{
		term: /\blevel[- ]?set\b/i,
		suggest: "align / agree on expectations",
		sources: "SJSU"
	},
	{
		term: /\bpush the envelope\b/i,
		suggest: "go beyond limits / innovate",
		sources: "SJSU, A11y Collective"
	},
	{
		term: /\bthink outside the box\b/i,
		suggest: "think creatively / find new approaches",
		sources: "SJSU, A11y Collective"
	},
	{
		term: /\bwrap (my|your|our|their) head[s]? around\b/i,
		suggest: "understand / make sense of",
		sources: "A11y Collective"
	},
	{
		term: /\bone[- ]?size[- ]?fits[- ]?all\b/i,
		suggest: "universal / the same for everyone",
		sources: "Canadian Gov"
	},
	{
		term: /\bback to square one\b/i,
		suggest: "starting over / back to the beginning",
		sources: "SJSU, A11y Collective"
	},
	{
		term: /\bin the pipeline\b/i,
		suggest: "planned / coming soon / in progress",
		sources: "SJSU, A11y Collective"
	},
	{
		term: /\bon the same page\b/i,
		suggest: "in agreement / aligned",
		sources: "SJSU, Canadian Gov"
	},
	{
		term: /\bcatch[- ]22\b/i,
		suggest: "impossible situation / no-win situation",
		sources: "SJSU, A11y Collective"
	},
	{
		term: /\bwhistle[- ]?stop\b/i,
		suggest: "brief / quick",
		sources: "Canadian Gov"
	},
	{
		term: /\braise the bar\b/i,
		suggest: "set a higher standard / improve expectations",
		sources: "SJSU"
	},
	{
		term: /\bhit the ground running\b/i,
		suggest: "start immediately / begin without delay",
		sources: "SJSU, A11y Collective"
	},
	{
		term: /\bon the fence\b/i,
		suggest: "undecided / uncertain",
		sources: "SJSU, A11y Collective"
	},
	{
		term: /\bbite the bullet\b/i,
		suggest: "endure something difficult / proceed despite difficulty",
		sources: "SJSU, A11y Collective"
	},
	{
		term: /\bunder the weather\b/i,
		suggest: "unwell / sick / not feeling well",
		sources: "SJSU, A11y Collective"
	},
	{
		term: /\bball ?park (figure|estimate|number)?\b/i,
		suggest: "rough estimate / approximate",
		sources: "SJSU, Canadian Gov"
	},
	{
		term: /\bin the ball ?park\b/i,
		suggest: "approximately / roughly",
		sources: "SJSU, Canadian Gov"
	},
	{
		term: /\bhit it out of the park\b/i,
		suggest: "succeed greatly / do exceptionally well",
		sources: "SJSU, A11y Collective"
	},
	{
		term: /\bslam[- ]?dunk\b/i,
		suggest: "certain success / easy win",
		sources: "SJSU, A11y Collective"
	},
	{
		term: /\bdrop the ball\b/i,
		suggest: "make a mistake / fail to follow through",
		sources: "SJSU, A11y Collective"
	},
	{
		term: /\bgame[- ]?changer\b/i,
		suggest: "major shift / significant development",
		sources: "SJSU, Canadian Gov"
	},
	{
		term: /\blevel (the |a )?playing field\b/i,
		suggest: "create equal conditions / remove advantages",
		sources: "SJSU, A11y Collective"
	},
	{
		term: /\bmove the goal[- ]?posts\b/i,
		suggest: "change the requirements / shift the target",
		sources: "SJSU, A11y Collective"
	},
	{
		term: /\bpinch[- ]?hitter\b/i,
		suggest: "substitute / stand-in / backup",
		sources: "SJSU"
	},
	{
		term: /\bkick[- ]?off\b(?!\s+(meeting|call|event))/i,
		suggest: "start / begin / launch",
		sources: "A11y Collective"
	},
	{
		term: /\btouch ?base\b/i,
		suggest: "check in / reconnect / follow up",
		sources: "SJSU, Canadian Gov"
	},
	{
		term: /\bpar for the course\b/i,
		suggest: "expected / typical / normal",
		sources: "SJSU"
	},
	{
		term: /\bfield (a |the )?question\b/i,
		suggest: "answer / respond to / address",
		sources: "SJSU"
	}
];
/**
...
var ALT_TEXT_FILENAME_PATTERN = /\.(png|jpe?g|gif|svg|webp|bmp|avif|tiff?|ico)(\s.*)?$/i;
/**
...
*/
var DIRECTIONAL_PATTERNS = [
	{
		term: /\b(the )?(right[- ]hand |left[- ]hand )?(side)?bar\b/i,
		suggest: "use a heading or section name instead",
		sources: "SBA, Google Dev Style"
	},
	{
		term: /\bin the (right|left) (column|panel|sidebar|navigation|nav|menu)\b/i,
		suggest: "use a heading or section name instead",
		sources: "SBA, Google Dev Style"
	},
	{
		term: /\b(see|refer to|check|click) (the )?(above|below)\b/i,
		suggest: "\"see [section name]\" or restructure",
		sources: "SBA, Google Dev Style"
	},
	{
		term: /as (shown|seen|described|mentioned|noted) (above|below)\b/i,
		suggest: "\"as described in [section]\" or restructure",
		sources: "SBA, Google Dev Style"
	},
	{
		term: /\bthe following (image|figure|table|chart|diagram) (above|below)\b/i,
		suggest: "refer to the item by its caption or figure number",
		sources: "SBA"
	}
];
/**
...
* A11y Collective.
*/
function createNoAbleistLanguageRule() {
	return {
		meta: {
			type: "suggestion",
			docs: {
			...
			messages: { ableist: "\"{{term}}\" is ableist language. Suggestion: {{suggest}}. ({{sources}})" },
			schema: [{
				type: "object",
				properties: { allow: {
					type: "array",
		...
		create(context) {
			...
			return {
				...
				TemplateLiteral(node) {
					for (const quasi of node.quasis) checkTermList(quasi, quasi.value.raw, ABLEIST_TERMS, allow, context, "ableist");
				}
			};
		}
	};
...
*/
function createNoDisabilityMetaphorRule() {
	return {
		meta: {
			type: "suggestion",
			docs: {
			...
			messages: { metaphor: "\"{{term}}\" uses disability as a metaphor. Suggestion: {{suggest}}. ({{sources}})" },
			schema: [{
				type: "object",
				properties: { allow: {
					type: "array",
		...
		create(context) {
			...
			return {
				...
				TemplateLiteral(node) {
					for (const quasi of node.quasis) checkTermList(quasi, quasi.value.raw, DISABILITY_METAPHORS, allow, context, "metaphor");
				}
			};
		}
	};
...
*/
function createNoEnglishIdiomRule() {
	return {
		meta: {
			type: "suggestion",
			docs: {
			...
			messages: { idiom: "\"{{term}}\" is an idiom that may be unclear to ESL readers. Suggestion: {{suggest}}. ({{sources}})" },
			schema: [{
				type: "object",
				properties: { allow: {
					type: "array",
		...
		create(context) {
			...
			return {
				...
				TemplateLiteral(node) {
					for (const quasi of node.quasis) checkTermList(quasi, quasi.value.raw, ENGLISH_IDIOMS, allow, context, "idiom");
				}
			};
		}
	};
...
function createNoVagueCTARule() {
	return {
		meta: {
			...
			messages: { vagueCta: "\"{{text}}\" is vague link or button text that fails WCAG 2.4.4. Screen reader users navigating by links will hear \"{{text}}\" with no context. Use descriptive text that explains the destination or action. (W3C WAI, WebAIM Million)" },
			schema: [{
				type: "object",
				properties: { allow: {
					type: "array",
		...
		create(context) {
			...
			return { JSXElement(node) {
				...
				if (VAGUE_CTA_PATTERNS.some((p) => p.test(text))) context.report({
					node: opening,
					messageId: "vagueCta",
					data: { text }
				});
...
*/
function createNoDirectionalLanguageRule() {
	return {
		meta: {
			type: "suggestion",
			docs: {
			...
			messages: { directional: "{{match}} uses layout position to give instructions. Position-based references break when users zoom, reflow, or use screen readers. {{suggest}} (SBA, Google Dev Style, WCAG SC 1.3.3)" },
			schema: []
		},
		create(context) {
			return { Literal(node) {
...
* Canadian Gov.
*/
function createNoUnexplainedAbbreviationRule() {
	...
	return {
		meta: {
			...
			messages: { unexplained: "\"{{abbr}}\" is used without explanation. Expand it on first use: \"{{abbr}} (full name)\" or \"full name ({{abbr}})\". (WCAG SC 3.1.4, Google Dev Style, GOV.UK)" },
			schema: [{
				type: "object",
				properties: { known: {
					type: "array",
		...
		create(context) {
			...
			return {
				...
				Literal(node) {
					...
					while ((m = EXPANSION_PATTERN.exec(text)) !== null) defined.add(m[1] ?? m[4]);
						...
						context.report({
							...
							loc: {
								start: {
									...
									column: node.loc.start.column + 1 + m.index
								},
								end: {
									line: node.loc.start.line,
									column: node.loc.start.column + 1 + m.index + abbr.length
								}
							}
						});
						defined.add(abbr);
...
function createNoAllCapsProse() {
	...
	return {
		meta: {
			...
			messages: { allCaps: "\"{{word}}\" is written in ALL CAPS. Screen readers using high verbosity may read it letter-by-letter. Use regular casing; add to the `known` option if this is a recognized acronym. (Google Dev Style, GOV.UK)" },
			schema: [{
				type: "object",
				properties: { known: {
					type: "array",
					...
					context.report({
						...
						loc: {
							start: {
								...
								line: node.loc.start.line,
								column: node.loc.start.column + 1 + m.index + word.length
							}
						}
					});
				}
...
*/
function createNoVagueErrorMessageRule() {
	const VAGUE_ERRORS = [
		/^an? error occurred\.?$/i,
	...
	return {
		meta: {
			...
			messages: { vagueError: "\"{{text}}\" does not explain what went wrong or how to fix it, failing WCAG SC 3.3.1 and 3.3.3. Describe the specific error and provide a corrective action. (UX Content Co., Google Dev Style)" },
			schema: []
		},
		create(context) {
			return { Literal(node) {
				...
				if (VAGUE_ERRORS.some((p) => p.test(text))) context.report({
					node,
					messageId: "vagueError",
					data: { text }
				});
			} };
		}
...
*/
function createNoAmpersandInProseRule() {
	return {
		meta: {
			type: "suggestion",
			docs: {
			...
			messages: { ampersand: "\"&\" may be announced inconsistently by screen readers. Use \"and\" in prose. (Google Dev Style)" },
			schema: []
		},
		create(context) {
			return { Literal(node) {
				if (typeof node.value !== "string") return;
				if (/\s&\s/.test(node.value)) context.report({
					node,
					messageId: "ampersand"
				});
			} };
...
*/
function buildContentRecommendedRules(ns) {
	return {
...
function extractJSXText(node) {
	let text = "";
	for (const child of node.children ?? []) if (child.type === "JSXText") text += child.value;
	else if (child.type === "JSXExpressionContainer" && child.expression.type === "Literal") text += String(child.expression.value);
	else if (child.type === "JSXElement") text += extractJSXText(child);
	return text;
}
//#endregion
export { ABLEIST_TERMS, ALT_TEXT_FILENAME_PATTERN, ALT_TEXT_PREFIXES, CONTENT_RULE_FACTORIES, DIRECTIONAL_PATTERNS, DISABILITY_METAPHORS, ENGLISH_IDIOMS, VAGUE_CTA_PATTERNS, buildContentRecommendedRules, createNoAbleistLanguageRule, createNoAllCapsProse, createNoAmpersandInProseRule, createNoDirectionalLanguageRule, createNoDisabilityMetaphorRule, createNoEnglishIdiomRule, createNoUnexplainedAbbreviationRule, createNoVagueCTARule, createNoVagueErrorMessageRule };

//# sourceMappingURL=@a11yfred_neighbor_rules.js.map